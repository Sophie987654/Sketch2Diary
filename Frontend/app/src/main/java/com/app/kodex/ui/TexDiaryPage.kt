...
@Composable
fun TexDiaryPage(text : String?)
{
    val texts = listOf<DiaryText>(DiaryText(
        "2024년 2월 3일 토요일",text),DiaryText(
        "2023년 1월 14일 목요일","오늘은 나무를 파고 놀았다. 나무에서 벌레를 보고 도망갔다. 엄마가 없어서 너무 재미있진 않았다. 그래도 내일은\n" +
